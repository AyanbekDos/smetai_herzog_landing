...
const CASES = [
  {
    slug: "uks-capital-renovation",
    title: "УКС · капитальный ремонт",
    ...
    report: "/samples/smetai-uks-capital-report.xlsx",
    sources: "/samples/smetai-uks-capital-sources.zip",
  },
  {
    slug: "school-reconstruction",
    title: "Муниципальная школа · реконструкция",
    ...
    report: "/samples/smetai-school-reconstruction-report.xlsx",
    sources: "/samples/smetai-school-reconstruction-sources.zip",
  },
  {
    slug: "education-center-upgrade",
    title: "Образовательный центр · модернизация",
    ...
    report: "/samples/smetai-education-center-upgrade-report.xlsx",
    sources: "/samples/smetai-education-center-upgrade-sources.zip",
  },
];
